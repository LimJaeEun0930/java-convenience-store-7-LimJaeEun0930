...
public class Constants {
    ...
    public static final String OUT_RECEIPT_PRODUCT_NAME_QUANTITY_PRICE_IMPL = "%s\t\t%d\t\t  %s";
    ...
    public static final String ERROR_IN_WRONG_INPUT_ETC = "[ERROR] 잘못된 입력입니다. 다시 입력해 주세요.";
    public static final String ERROR_NON_EXIST_PRODUCT = "[ERROR] 존재하지 않는 상품입니다. 다시 입력해 주세요.";
    public static final String ERROR_CANNOT_READ_FILE = "[ERROR] 파일을 불러들이지 못했습니다.";
    public static final String ERROR_CANNOT_BUY_PRODUCT_OVER_QUANTITY = "[ERROR] 재고 수량을 초과하여 구매할 수 없습니다. 다시 입력해 주세요.";
}
